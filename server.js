...
app.post("/api/sales", (req, res) => {
  myData
    ...
    .catch(err => res.send(`Error when add New sales ${err}`));
});
...
app.get("/api/sales", (req, res) => {
  myData
    ...
    .then(data => res.json(data))
    .catch(err => res.send(`Error when loading all sales ${err}`));
});
...
app.get("/api/sales/:id", (req, res) => {
  myData
    ...
    .then(data => res.json(data))
    .catch(err => res.send(`Error when getting sale by id ${err}`));
});
...
app.put("/api/sales/:id", (req, res) => {
  myData
    ...
    .then(data => res.json(data))
    .catch(err => res.send(`Error when Update existing sale ${err}`));
});
...
app.delete("/api/sales/:id", (req, res) => {
  myData
    ...
    .then(data => res.json(data))
    .catch(err => res.send(`Error when deleting sale: ${err}`));
});
